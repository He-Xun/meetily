...
const TABS = [
  { value: 'general', label: 'settingsPage.tabs.general', icon: Settings2 },
  { value: 'recording', label: 'settingsPage.tabs.recordings', icon: Mic },
  { value: 'Transcriptionmodels', label: 'settingsPage.tabs.transcription', icon: DatabaseIcon },
  { value: 'summaryModels', label: 'settingsPage.tabs.summary', icon: SparkleIcon },
  { value: 'beta', label: 'settingsPage.tabs.beta', icon: FlaskConical }
] as const;

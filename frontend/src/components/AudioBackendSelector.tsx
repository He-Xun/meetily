  ...
  return (
    <div className="space-y-2">
        ...
        <div className="relative">
          ...
          {showTooltip && (
            <div className="absolute z-10 left-6 top-0 w-64 p-3 text-xs bg-gray-900 text-white rounded-lg shadow-lg">
              <p className="font-semibold mb-1">{t('settings.audioDevices')}</p>
              ...
              <p className="mt-2 text-gray-300">
                {t('settings.backendSelectionNote')}
              </p>
            </div>
          )}
        </div>
      ...
      <div className="text-xs text-gray-500 space-y-1">
        <p>• {t('settings.backendSelectionNote')}</p>
        <p>• {t('settings.microphoneAlwaysDefault')}</p>
        <p>• {t('settings.changesApplyNewSessions')}</p>
      </div>
    </div>
  );
}
...
export function SettingTabs({ 
  ...
  <TabsList>
    <TabsTrigger value="transcriptSettings">{t('settingsTabs.transcription')}</TabsTrigger>
    <TabsTrigger value="modelSettings">{t('settingsTabs.summary')}</TabsTrigger>
    <TabsTrigger value="recordingSettings">{t('settingsTabs.recordings')}</TabsTrigger>
